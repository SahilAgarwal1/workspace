...
constexpr int kMaxAudioSampleSize = 512; // possibly 480?
...
// slice stride
constexpr int kFeatureSliceStrideMs = 20; // 20 ms of stride
// Duration in millis of a slide
constexpr int kFeatureSliceDurationMs = 30; // 30 ms goes into fft
