...
count		.set		3				;number of characters to add in EEL4511 ('E'+'E'+'L')
...
_c_int00:			;This label tells the linker where the entry (starting) point for
					;the first instruction in your program.	
								...
								;Short example1 to sum 1st three chars in string EEL4511.
								;This illustrates immediate, indirect and register addr modes
		MOVL	XAR0,#char		;address of 1st char in EEL4511
		MOVL	XAR1,#sum		;address of where final sum (result)will be stored
		MOVL	XAR2,#counter	;address of counter saved in memory
...
;
		...
		MOV		DP,#ebss_sect>>6	;set datapage pointer to point to .bss section
